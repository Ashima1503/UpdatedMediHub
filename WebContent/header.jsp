...
<%@ page import="com.medihub.service.impl.*,com.medihub.service.*"%>
...
<body style="background-color: #E6F9E6;" >	
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #004080; color: white; padding: 5px;">
		<h2>MediHub</h2>
		<h6>We specialize in medical supplies</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>MediHub</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=Syrups">Syrup</a></li>
							<li><a href="index.jsp?type=Antibioetics">Antibiotics</a></li>
							<li><a href="index.jsp?type=Surgical">Surgical Instruments</a></li>
							<li><a href="index.jsp?type=Diagnostic">Diagnostic Equipments</a></li>
							<li><a href="index.jsp?type=Skincare">Skincare</a></li>
